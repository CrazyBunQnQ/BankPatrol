		...
		<form action="../piwoker/updatePiwoker.do" method="post">
			<table width="60%" border="0" align="center" cellpadding="2"
				...
				<tr bgcolor="#F2F2F2">
					...
					<td><input name="wokerId" value="${piWorker.id}" readonly></td>
					</tr>
					<tr bgcolor="#F2F2F2" >
					<td  align="center">巡检工姓名：</td>
					<td><input name="workerName" value="${piWorker.workerName}"></td>
					</tr>
					<tr bgcolor="#F2F2F2" >
					<td  align="center">电话1：</td>
					<td><input name="workerTel1" value="${piWorker.tel1 }"></td>
					</tr>
					<tr bgcolor="#F2F2F2" >
					<td  align="center">电话2：</td>
					<td><input name="workerTel2" value="${piWorker.tel2 }"></td>
					</tr>
			</table><br>
